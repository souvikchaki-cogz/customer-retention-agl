-- =============================================================================
-- AGL Energy Customer Churn Retention System
-- Seed the initial ACTIVE ruleset into dbo.agl_rules_library.
--
-- This script is idempotent:
--   1. Deactivates any currently ACTIVE ruleset (sets status = 'INACTIVE')
--   2. Inserts the AGL baseline ruleset as the new ACTIVE version (1.0.0)
--
-- Rules T1-T5  -> Scenario 2: Move-Out / Life Event   (Very High churn, days-weeks)
-- Rules T6-T10 -> Scenario 1: Bill Shock / Comparing  (Medium-High churn, 2-6 weeks)
-- =============================================================================

-- Step 1: Deactivate any existing ACTIVE ruleset
UPDATE dbo.agl_rules_library
SET status = 'INACTIVE'
WHERE status = 'ACTIVE';

-- Step 2: Insert the AGL baseline ruleset as the new ACTIVE version
